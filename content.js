...
// async function createWorkerStockfish10() {
//   const code = await loadWorkerScript("lib/stockfish10.js");
...
(async()=>{
  ...
  let engine = new Stockfish11()

  engine.getMovesByFen("r1bqkbnr/pppn1ppp/3p4/4p2Q/2B1P3/8/PPPP1PPP/RNB1K1NR w KQkq - 2 4","white").then((moves)=>{
    console.log(moves)
  })
