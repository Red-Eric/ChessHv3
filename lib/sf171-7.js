var Sf1717Web = ( () => {
    ...
    return (async function(moduleArg={}) {
        ...
        ), ia = "object" == typeof window, k = "undefined" != typeof WorkerGlobalScope, l = k && self.name?.startsWith("em-pthread");
        ...
        h.setNnueBuffer = function(a, b=0) {
            if (!a)
                throw Error("buf is null");
            if (0 >= a.byteLength)
                throw Error(`${a.byteLength} bytes?`);
        ...
        h.uci = function(a) {
            const b = na(a) + 1
              , c = la(b);
            if (!c)
                throw Error(`Could not allocate ${b} bytes`);
            oa(a, pa(), c, b);
            qa(c)
        }
        ;
        ...
        var ra = [], p = "", sa, ua;
        if (ia || k)
            k ? p = self.location.href : "undefined" != typeof document && document.currentScript && (p = document.currentScript.src),
            ...
            ;
        var va = console.log.bind(console), q = console.error.bind(console), t, wa, xa = !1, u, v, ya, za, Aa, Ba, w, Ca, Da = !1;
        function x() {
            t.buffer != v.buffer && z();
            return v
        }
            ...
            function a(b) {
                try {
                    ...
                    if ("load" === d) {
                        ...
                        "setimmediate" !== c.target && ("checkMailbox" === d ? Ha && Na() : d && (q(`worker: received unknown command ${d}`),
                        q(c)))
                } catch (e) {
                    throw Oa(),
                    e;
        ...
        function Pa() {
            l ? startWorker(h) : (h.noFSInit || Qa || (Qa = !0,
        ...
        var Eb = a => {
          ...
          , L = (a, b, ...c) => {
            for (var d = 2 * c.length, e = Jb(), f = Kb(8 * d), g = f >> 3, m = 0; m < c.length; m++) {
                var r = c[m];
                "bigint" == typeof r ? (w[g + 2 * m] = 1n,
                w[g + 2 * m + 1] = r) : (w[g + 2 * m] = 0n,
                Fa()[g + 2 * m + 1] = r)
            }
            a = Lb(a, 0, d, f, b);
            Mb(e);
        ...
        var Hb = a => new Promise(b => {
            a.onmessage = f => {
                ...
                if (f.Ba && f.Ba != Xb()) {
                    ...
                    g && q(`worker sent an unknown command ${g}`)
            }
            ;
            a.onerror = f => {
            ...
            for (e of d)
                h.propertyIsEnumerable(e) && c.push(e);
            a.postMessage({
                la: "load",
                Xa: c,
                jb: t,
        ...
        function Gb() {
            if (h.mainScriptUrlOrBlob) {
                ...
                a = new Worker(new URL("sf171-7.js",import.meta.url),{
                    type: "module",
                    name: "em-pthread"
                });
            H.push(a)
        ...
        var nc = {
          ...
          , oc = {
            ...
            Ga(a, b) {
                null === b || 10 === b ? (va(P(a.output)),
                a.output = []) : 0 != b && a.output.push(b)
            },
            wa(a) {
                0 < a.output?.length && (va(P(a.output)),
                a.output = [])
            },
            Za() {
                return {
          ...
          , pc = {
            Ga(a, b) {
                null === b || 10 === b ? (q(P(a.output)),
                a.output = []) : 0 != b && a.output.push(b)
            },
            wa(a) {
                0 < a.output?.length && (q(P(a.output)),
                a.output = [])
            }
        }
          , S = {
            ...
            createNode(a, b, c, d) {
                ...
                c = rc(a, b, c, d);
                16384 === (c.mode & 61440) ? (c.ca = S.ia.dir.node,
                c.aa = S.ia.dir.stream,
                c.ba = {}) : 32768 === (c.mode & 61440) ? (c.ca = S.ia.file.node,
                c.aa = S.ia.file.stream,
                c.ea = 0,
                c.ba = null) : 40960 === (c.mode & 61440) ? (c.ca = S.ia.link.node,
                c.aa = S.ia.link.stream) : 8192 === (c.mode & 61440) && (c.ca = S.ia.Ja.node,
                c.aa = S.ia.Ja.stream);
            ...
            ca: {
                ...
                ka(a, b) {
                    for (var c of ["mode", "atime", "mtime", "ctime"])
                        null != b[c] && (a[c] = b[c]);
                    void 0 !== b.size && (b = b.size,
                    a.ea != b && (0 == b ? (a.ba = null,
                    a.ea = 0) : (c = a.ba,
            ...
            aa: {
                ...
                write(a, b, c, d, e, f) {
                    ...
                    if (b.subarray && (!a.ba || a.ba.subarray)) {
                        if (f)
                            return a.ba = b.subarray(c, c + d),
                            a.ea = d;
                        if (0 === a.ea && 0 === e)
                            return a.ba = b.slice(c, c + d),
                            a.ea = d;
                        if (e + d <= a.ea)
                            return a.ba.set(b.subarray(c, c + d), e),
                            d
                    }
                    f = e + d;
                    var g = a.ba ? a.ba.length : 0;
                    g >= f || (f = Math.max(f, g * (1048576 > g ? 2 : 1.125) >>> 0),
                    0 != g && (f = Math.max(f, 256)),
                    g = a.ba,
                    a.ba = new Uint8Array(f),
                    0 < a.ea && a.ba.set(g.subarray(0, a.ea), 0));
                    if (a.ba.subarray && b.subarray)
                        a.ba.set(b.subarray(c, c + d), e);
                    else
                        for (f = 0; f < d; f++)
                            a.ba[e + f] = b[c + f];
        ...
        function Sa(a, b, c=438) {
            ...
            if (b & 65536 && 16384 !== (d.mode & 61440))
                throw new R(54);
            if (!f && (e = d ? 40960 === (d.mode & 61440) ? 32 : 16384 === (d.mode & 61440) && ("r" !== Bc(b) || b & 576) ? 31 : Ac(d, Bc(b)) : 44))
                throw new R(e);
            if (b & 512 && !f) {
                e = d;
        ...
        function db(a, b, c) {
            ...
            try {
                ...
                if ("undefined" == typeof Y || "ErrnoError" !== g.name)
                    throw g;
                return -g.oa
            }
        }
        function eb(a, b, c, d) {
            ...
            try {
                ...
                if ("undefined" == typeof Y || "ErrnoError" !== m.name)
                    throw m;
                return -m.oa
            }
        }
        var fb = () => Va("")
          ...
          , La = a => {
            "function" === typeof Atomics.ib && (Atomics.ib(A(), a >> 2, a).value.then(Na),
            a += 128,
        ...
        var Sc = () => {
            Sc.Ia || (Sc.Ia = {});
            Sc.Ia["Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"] || (Sc.Ia["Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"] = 1,
            q("Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"))
        }
        , pb = () => {
            k || (Sc(),
            Va("Blocking on the main thread is not allowed by default. See https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"))
        }
        , qb = () => {
            K += 1;
            throw "unwind";
        }
        , sb = () => navigator.hardwareConcurrency, tb = a => {
            var b = pa().length;
            a >>>= 0;
            if (a <= b || 2147483648 < a)
                return !1;
        ...
        , Tc = {}, Vc = () => {
            if (!Uc) {
                ...
                for (b in Tc)
                    void 0 === Tc[b] ? delete a[b] : a[b] = Tc[b];
                var c = [];
                for (b in a)
                    c.push(`${b}=${a[b]}`);
                Uc = c
        ...
        function zb(a, b, c, d) {
            ...
            try {
                ...
                if ("undefined" == typeof Y || "ErrnoError" !== Q.name)
                    throw Q;
                return Q.oa
            }
        }
        ...
        h.UTF8ToString = ja;
        h.stringToUTF8 = Z;
        var Oc = [Cb, Ob, bc, cb, db, eb, mb, vb, wb, yb, zb, Ab, Bb], ab, C = await (async function() {
            function a(d, e) {
                C = d.exports;
                Sb.push(C.K);
                $b = C.N;
            ...
            Wa ??= h.locateFile ? h.locateFile ? h.locateFile("sf171-7.wasm", p) : p + "sf171-7.wasm" : (new URL("sf171-7.wasm",import.meta.url)).href;
            try {
                var c = await Za(b);
